...
a
    level_first_descyption = """ 
    ##########################################################################################
   #The first board is your Hippie working space.                                              #
   #If he wont to leave this place he has to talk to all his "0-look-like" co-workers.        #
   #Ther arguments are not the best and they can decrease your level of happiness.            #
...
def level_second_description():
    level_second_description = """
    #############################################################################
   # In this level, you Hippie will meet The Boss.                              #
   # Before you get to his office you have to walk through the salty            #
   # lake of tear those who were there before. Try not to touch them.           #
   #                                                                            #
...
return level_second_descyption
